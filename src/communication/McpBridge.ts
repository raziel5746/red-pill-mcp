...
import { McpMessage, PopupConfig, PopupResponse, ExtensionState } from '../types';
...
export class McpBridge extends EventEmitter {
    ...
    private parseMessage(data: WebSocket.Data): McpMessage {
        try {
    ...
    private handlePopupMessage(message: McpMessage): void {
        try {
            const popupConfig = message.payload as PopupConfig;
    ...
    private handleStatusMessage(message: McpMessage): void {
